...
const HomeWrapper = ({ children }: { children: React.ReactNode }) => {
  ...
  return <div style={{ backgroundImage: "url('/images/bg.jpg')" }} className="w-screen h-screen justify-center items-center flex">
    <Modal open={openModal} onOpenChange={setOpenModal}>
      <ModalContent style={{ fontFamily: "Luckiest Guy, cursive", }} className='w-[342px] bg-gradient-to-b from-blue-600 via-blue-700 to-blue-900 flex flex-col justify-center items-center rounded-md p-3'>
